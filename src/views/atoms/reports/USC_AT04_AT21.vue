...
export default {
  ...
  data() {
    return {
      ...
      columns: [
        {
          headerName: "Código cuenta SIB",
          field: "COD_CUENTA_SIB",
          headerClass: 'headerBlue',
          cellClass: 'stringType',
        },
        {
          headerName: "Monto AT04",
          field: "MONTO_AT04",
          headerClass: 'headerBlue',
          cellClass: 'numberType',
          sortable: false,
          valueFormatter: params => this.currencyFormatFn(params.data.MONTO_AT04),
        },
        {
          headerName: "Monto AT21",
          field: "MONTO_AT21",
          cellClass: 'numberType',
          headerClass: 'headerBlue',
          sortable: false,
          valueFormatter: params => this.currencyFormatFn(params.data.MONTO_AT21),
          width: '180px'
        },
        {
        ...
        {
          headerName: "Código Bien Adquirido SB10",
          field: "COD_BIEN_ADQUIRIDO_SB10",
          sortable: false,
          headerClass: 'headerBlue',
          cellClass: 'stringType',
        },
    ...
    async generateReport() {
      try {
        ...
        const res = await this.$http.post(
            environment.uri + "/reportes/validator/code/766/",
            {
